    ...
    return (
        <>
            ...
            <div className="navbar-end">
                ...
                {
                    user?.uid ? <h4 className='mx-2'>Welcome, {user?.displayName} {user?.email ? <button className="btn btn-sm" onClick={handleLogOut}><Link>Log Out</Link></button> : <Link href='/' className="btn btn-sm">Login</Link>}</h4> : <Link href='/' className="btn btn-sm">Login</Link>
                }
            </div>
            </div>
        </>
